...
// Explorer Classes (Adventurer in MSEA)
// 0 <= Job ID < 1000
  0: 'Beginner',
  ...
  // KoC Classes
  // 1000 <= Job ID < 2000, 5000 <= Job ID < 6000 (Mihile)
  ...
  // Special jobs
  // Misc Job IDs that are either deprecated or used for other things
  800: 'Manager',
  900: 'GM',
  910: 'Super GM',
  8000: 'Riding Skills',
